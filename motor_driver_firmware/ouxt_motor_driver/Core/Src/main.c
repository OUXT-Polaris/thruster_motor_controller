...
int main(void)
{
  ...
  motorTImerHandle = osTimerCreate(osTimer(motorTImer), osTimerPeriodic, (void*) &motor);

  /* USER CODE BEGIN RTOS_TIMERS */
  /* start timers, add new ones, ... */
  osTimerStart(motorTImerHandle, 30);
...
void motorCallback(void const * argument)
{
  ...
  osSemaphoreWait(motorSpeedSemaphoreHandle, osWaitForever);
  motorSetSpeed((MotorHandleType *)argument, ros_data.motor_speed);
  osSemaphoreRelease(motorSpeedSemaphoreHandle);
